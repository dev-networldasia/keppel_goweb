...
function updateLanguageControl(lang) {
  ...
  if (langSelectedEl) {
    ...
    if (lang === "en") {
      langSelectedEl.querySelector("img.flag").src = "img/menu/flag-us.png";
    } else {
      langSelectedEl.querySelector("img.flag").src = "img/menu/flag-vietnam.png";
    }
    ...
    if (this.readyState === 4 && this.status === 200) {
      ...
      Object.keys(data).forEach(function (key) {
        ...
        Array.from(imgElements).forEach(function (elem) {
          var imagePath = data[key].replace("", siteBaseURL); // Replace {{site}} with base URL
          elem.src = imagePath;
        });
